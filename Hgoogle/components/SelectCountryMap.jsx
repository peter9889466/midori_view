  ...
  return (
    <div>
      ...
      <div style={{ 
        ...
        <h3 style={{ margin: '0 0 15px 0' }}>국가 선택 (국가 중심점 기준 연결)</h3>
        ...
        <div style={{ marginBottom: '15px' }}>
          ...
          <div style={{ display: 'flex', gap: '10px' }}>
            <input
              ...
              placeholder="국가명을 입력하세요 (예: 대한민국, 일본, 중국)"
              style={{
                flex: 1,
                padding: '8px',
                border: '1px solid #ccc',
        ...
        {/* 선택된 국가 정보 */}
        <div>
          <h4 style={{ margin: '0 0 10px 0' }}>선택된 국가:</h4>
          {selectedCountry ? (
            <div>
            ...
            <p style={{ margin: '5px 0', color: '#666', fontStyle: 'italic' }}>
              지도에서 국가를 클릭하거나 위에서 검색해주세요.
              <br />
              <small>대한민국과 선택된 국가의 중심점이 연결됩니다.</small>
            </p>
          )}
        </div>
      </div>
